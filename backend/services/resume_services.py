...
resume_prompt=ChatPromptTemplate.from_messages([
    ("system","""You are a professional resume analyser.ChatPromptTemplate
...
def analysis_resume(resume_text:str) ->str:
    responce=resume_chain.invoke({"resume_text":resume_text})
